...
class PlayerCharacter(Base):
    ...
    progression_source_session_id: Mapped[uuid.UUID | None] = mapped_column(Uuid, nullable=True)
    progression_refund_budget: Mapped[int] = mapped_column(Integer, default=0)
    progression_purchases: Mapped[list] = mapped_column(JSON, default=list)
