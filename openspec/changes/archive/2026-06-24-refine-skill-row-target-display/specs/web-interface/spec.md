...
The left sidebar skills collapsible section SHALL display each catalog skill row with the skill name, linked attribute abbreviation in brackets, and owned skill advances when greater than zero, matching the inventory row layout pattern.

#### Scenario: Skill row shows linked attribute and advances
...
- **THEN** the row displays the skill name and meta label `[BS] +5`
